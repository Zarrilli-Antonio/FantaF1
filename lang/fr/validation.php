...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'La valeur donnée pour :attribute est apparue dans une fuite de données. Merci de choisir un(e) autre :attribute.',
    ],
    ...
    'attributes' => [
        ...
        'season_id' => 'saison',
        'driver_slots' => "pilotes dans l'effectif",
        'constructor_slots' => "équipes dans l'effectif",
        'budget' => 'budget de crédits',
