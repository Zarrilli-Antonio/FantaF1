...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-f1red text-start text-base font-medium text-white bg-gray-800/50 focus:outline-none transition duration-150 ease-in-out'
